(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@floating-ui/dom'), require('@floating-ui/utils/dom'), require('vue')) :
  typeof define === 'function' && define.amd ? define(['exports', '@floating-ui/dom', '@floating-ui/utils/dom', 'vue'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.FloatingUIVue = {}, global.FloatingUIDOM, global.FloatingUIUtilsDOM, global.Vue));
})(this, (function (exports, dom, dom$1, vue) { 'use strict';
  ...
  function arrow(options) {
    return {
      ...
      options,
      fn(args) {
        const element = unwrapElement(vue.toValue(options.element));
        if (element == null) {
          return {};
        }
        return dom.arrow({
  ...
  function useFloating(reference, floating, options) {
    ...
    const openOption = vue.computed(() => {
      var _toValue;
      return (_toValue = vue.toValue(options.open)) != null ? _toValue : true;
    });
    const middlewareOption = vue.computed(() => vue.toValue(options.middleware));
    const placementOption = vue.computed(() => {
      var _toValue2;
      return (_toValue2 = vue.toValue(options.placement)) != null ? _toValue2 : 'bottom';
    });
    const strategyOption = vue.computed(() => {
      var _toValue3;
      return (_toValue3 = vue.toValue(options.strategy)) != null ? _toValue3 : 'absolute';
    });
    const transformOption = vue.computed(() => {
      var _toValue4;
      return (_toValue4 = vue.toValue(options.transform)) != null ? _toValue4 : true;
    });
