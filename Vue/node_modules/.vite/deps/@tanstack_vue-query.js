import { $n as toRefs, Gn as readonly, Jn as shallowReadonly, Kn as ref, Nn as getCurrentScope, Ot as nextTick, Rn as isRef, U as computed, Vn as onScopeDispose, Wn as reactive, Yn as shallowRef, _n as watchEffect, gn as watch, ht as hasInjectionContext, nr as unref, qn as shallowReactive, xt as inject } from "./vue.runtime.esm-bundler-CR3Nwe7D.js";
import { t as setupDevtoolsPlugin } from "./esm-x9xX3k4D.js";
...
var MutationCache$1 = class extends Subscribable {
	constructor(config = {}) {
		super();
		this.config = config;
...
var QueryCache$1 = class extends Subscribable {
	constructor(config = {}) {
		super();
		this.config = config;
...
//#endregion
//#region node_modules/@tanstack/vue-query/build/modern/mutationCache.js
...
//#endregion
//#region node_modules/@tanstack/vue-query/build/modern/queryClient.js
...
//#endregion
//#region node_modules/@tanstack/vue-query/build/modern/devtools/devtools.js
...
function setupDevtools(app, queryClient) {
	setupDevtoolsPlugin({
		...
		api.on.setPluginSettings((payload) => {
			if (payload.key === "onlineMode") onlineManager.setOnline(Boolean(payload.newValue));
		});
		api.on.getInspectorTree((payload) => {
			if (payload.inspectorId === pluginId) {
				const queries = queryCache.getAll();
				const settings = api.getSettings();
				payload.rootNodes = (payload.filter ? queries.filter((item) => rankItem(item.queryHash, payload.filter).passed) : [...queries]).sort((a, b) => sortFns[settings.sortFn](a, b) * settings.baseSort).map((query) => {
...
var VueQueryPlugin = { install: (app, options = {}) => {
...
//#endregion
//#region node_modules/@tanstack/vue-query/build/modern/queryOptions.js
function queryOptions(options) {
	return options;
}
//#endregion
//#region node_modules/@tanstack/vue-query/build/modern/infiniteQueryOptions.js
function infiniteQueryOptions(options) {
	return options;
}
//#endregion
//#region node_modules/@tanstack/vue-query/build/modern/mutationOptions.js
...
//#endregion
//#region node_modules/@tanstack/vue-query/build/modern/useQueries.js
...
//#endregion
//#region node_modules/@tanstack/vue-query/build/modern/useInfiniteQuery.js
function useInfiniteQuery(options, queryClient) {
	return useBaseQuery(InfiniteQueryObserver, options, queryClient);
}
//#endregion
//#region node_modules/@tanstack/vue-query/build/modern/usePrefetchQuery.js
function isGetter$1(value) {
	return typeof value === "function";
}
function usePrefetchQuery(options, queryClient) {
	...
	const client = queryClient || useQueryClient();
	watchEffect(() => {
		const clonedOptions = cloneDeepUnref(isGetter$1(options) ? options() : unref(options));
		if (!client.getQueryState(clonedOptions.queryKey)) client.prefetchQuery(clonedOptions);
	});
}
//#endregion
//#region node_modules/@tanstack/vue-query/build/modern/usePrefetchInfiniteQuery.js
...
function usePrefetchInfiniteQuery(options, queryClient) {
	...
	const client = queryClient || useQueryClient();
	watchEffect(() => {
		const clonedOptions = cloneDeepUnref(isGetter(options) ? options() : unref(options));
		if (!client.getQueryState(clonedOptions.queryKey)) client.prefetchInfiniteQuery(clonedOptions);
	});
}
//#endregion
...
//#endregion
//#region node_modules/@tanstack/vue-query/build/modern/useIsFetching.js
...
//#endregion
//#region node_modules/@tanstack/vue-query/build/modern/useMutationState.js
...
//#endregion
export { CancelledError, InfiniteQueryObserver, Mutation, MutationCache, MutationObserver, QueriesObserver, Query, QueryCache, QueryClient, QueryObserver, VUE_QUERY_CLIENT, VueQueryPlugin, dataTagErrorSymbol, dataTagSymbol, defaultScheduler, defaultShouldDehydrateMutation, defaultShouldDehydrateQuery, dehydrate, environmentManager, streamedQuery as experimental_streamedQuery, focusManager, hashKey, hydrate, infiniteQueryOptions, isCancelledError, isServer, keepPreviousData, matchMutation, matchQuery, mutationOptions, noop, notifyManager, onlineManager, partialMatchKey, queryOptions, replaceEqualDeep, shouldThrowError, skipToken, timeoutManager, unsetMarker, useInfiniteQuery, useIsFetching, useIsMutating, useMutation, useMutationState, usePrefetchInfiniteQuery, usePrefetchQuery, useQueries, useQuery, useQueryClient };
